...
import { handleLoginAuthedUser } from "../actions/authedUserAction";
...
const Login = ({ dispatch, loggedIn }) => {
  ...
  return (
    <div className=" flex justify-center flex-col items-center gap-6">
      <h1 className=" text-red-600 text-5xl p-8 text-center font-mono">Login</h1>
      <div className="dropdown">
        <label data-testid="existing-user-label" tabIndex="0" className="btn btn-primary m-1">Existing User</label>
      ...
      <form onSubmit={handleSubmit} className=" form-control w-full max-w-xs space-y-6">
        ...
        <button data-testid="submit-login" className="btn btn-primary">Login</button>
      </form>
